...
class Filter extends React.Component {
    ...
    componentDidMount() {
        ...
        axios({
            method: 'POST',
            url: 'https://gentle-brushlands-53587.herokuapp.com/filter',
        ...
        axios({
            method: 'GET',
            url: 'https://gentle-brushlands-53587.herokuapp.com/locations',
            headers: { 'Content-Type': 'application/json' }
        })
            .then(response => {
    ...
    render() {
        ...
        const mealtypeName = sessionStorage.getItem('mealtypeName');
        return (
            <div>
                <div>

                    <div id="myId" className="heading">{mealtypeName}</div>
                            ...
                            <div className="col-sm-8 col-md-8 col-lg-8">
                                ...
                                {restaurants.length > 0 ?
                                    <div className="pagination">
                                        ...
                                        <span className="page-num" onClick={() => this.handlePageChange(page-1)}>&laquo;</span>}
                                        ...
                                        <span className="page-num" onClick={() => this.handlePageChange(page+1)}>&raquo;</span>}
