...
class QuickSearchItem extends React.Component {
    handleNavigate = (mealtypeId, mealtypeName) => {
        sessionStorage.setItem('mealtypeName', mealtypeName);
    ...
    render() {
        ...
        return (
            <div className="col-sm-12 col-md-6 col-lg-4" onClick={() => this.handleNavigate(id, heading)}>
